    ...
    <main className="w-full">
      ...
      <section className="px-6 pb-12">
        ...
        <div className="flex justify-center items-center gap-3 px-6">
          <Button className="paypal rounded-3xl min-w-32">PayPal</Button>
          <Button className="venmo rounded-3xl min-w-32">Venmo</Button>
          <Button className="kofi rounded-3xl min-w-32">Ko-fi</Button>
        </div>
      </section>
    </main>
  );
